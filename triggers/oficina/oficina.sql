...
AFTER
INSERT ON ReparacaoPeca FOR EACH ROW BEGIN
UPDATE Peca
...
AFTER
INSERT ON Reparacao FOR EACH ROW
    WHEN new.idCliente IS NULL BEGIN
UPDATE Reparacao
SET idCliente = (
        SELECT idCliente
        FROM Carro
...
END;
CREATE TRIGGER validaPecasReparacao BEFORE
INSERT ON ReparacaoPeca
    WHEN new.quantidade > (
        SELECT quantidade
        from Peca
        WHERE peca.idPeca = new.idPeca
    )
    OR new.idPeca NOT IN (
        SELECT idPeca
        FROM PecaModelo
            JOIN Carro USING(idModelo)
        WHERE idModelo = (
                SELECT idModelo
                FROM Carro
                WHERE idCarro = (
...
SELECT raise(ABORT, "nao tem quantidade");
END;
...
INSERT INTO CodPostal (codPostal1, localidade)
VALUES ('4200', 'Porto');
INSERT INTO CodPostal (codPostal1, localidade)
VALUES ('4400', 'Vila Nova de Gaia');
INSERT INTO CodPostal (codPostal1, localidade)
VALUES ('4450', 'Matosinhos');
-- Inser��o de registos na tabela Cliente
INSERT INTO Cliente (nome, morada, codPostal1, codPostal2, telefone)
VALUES (
        'Alberto Sousa',
        'Rua Brito e Cunha, 125',
        '4450',
        '086',
        '932853425'
    );
...
INSERT INTO Cliente (nome, morada, codPostal1, codPostal2, telefone)
VALUES (
        'Rodrigo Meireles de Aguiar',
        'Rua da Cunha, 310 1� Dir',
        '4200',
        '250',
        '928604666'
    );
...
VALUES (
        'Ad�o Lopes S�',
        'Rua Domingos de Matos, 200 3� Esq',
        '4400',
        '120',
        '963670913'
    );
...
SELECT *
FROM Reparacao;
-- Ver que o idCliente j� n�o � NULL;
...
INSERT INTO PecaModelo (idPeca, idModelo)
VALUES (1, 1);
INSERT INTO PecaModelo (idPeca, idModelo)
VALUES (2, 3);
...
VALUES (
        'Lu�s Pereira',
        'Rua Teixeira de Pascoaes, 117, 2� D',
        4450,
        117,
        '225901707',
        3
...
INSERT INTO FuncionarioReparacao (idFuncionario, idReparacao, numHoras)
VALUES (1, 1, 1);
INSERT INTO FuncionarioReparacao (idFuncionario, idReparacao, numHoras)
VALUES (4, 1, 4);
INSERT INTO FuncionarioReparacao (idFuncionario, idReparacao, numHoras)
